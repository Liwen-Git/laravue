        ...
        <el-row class="header-menu">
            ...
            <el-col :span="15">
                <el-breadcrumb separator="/">
                    <el-breadcrumb-item v-for="bc in breadcrumb" :to="{ path: bc.path }" :key="bc.path"> {{
                        $t(`meta.title.${bc.meta.title}`) }}
                    </el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
            <el-col :span="8">
        ...
        <el-dialog :title="$t('changePassword')" :visible.sync="dialogChangePasswordFormVisible" width="30%">
            <el-form :model="changePasswordForm" :rules="rules" ref="changePasswordForm">
                ...
                <el-form-item :label="$t('confirmPassword')" prop="password_confirmation" :label-width="formLabelWidth">
                    <el-input v-model="changePasswordForm.password_confirmation" type="password"
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            return {
                adminAvatar: config.hostUrl + '/laravue.png',
