    ...
    export default {
        ...
        methods: {
            ...
            handleDelete(index, row) {
                this.$http.delete(`/api/permission/${row.id}`).then(() => {
            ...
            handleAddPermission() {
                this.$refs['addForm'].validate((valid) => {
                    if (valid) {
                        this.$http.post('/api/permission', this.addForm).then(() => {
                            addSuccess(this);
                            this.requestData()
                        })
                    } else {
            ...
            handleEditPermission() {
                this.$refs['editForm'].validate((valid) => {
                    if (valid) {
                        this.$http.patch(`/api/permission/${this.nowRowData.row.id}`, this.editForm).then(() => {
                            editSuccess(this)
                        })
                    } else {
                        return false;
